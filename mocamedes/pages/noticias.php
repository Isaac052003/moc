...
<main style="min-height:60vh; display:flex; align-items:center; justify-content:center;">
  <div class="container" style="text-align:center; padding: 4rem 1rem;">
    ...
    <h2 style="font-size:2rem; margin-bottom:0.75rem;">Notícias</h2>
    <p style="color:var(--muted-foreground); max-width:480px; margin:0 auto 2rem;">
      Esta secção está em desenvolvimento. Em breve poderá consultar as últimas notícias da Administração Municipal de Moçâmedes.
    </p>
